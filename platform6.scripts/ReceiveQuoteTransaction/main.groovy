...
def quoteContent = pipeline.get 'ubl'
...
def sourceURI = "file://$B2BOX_DATA/resources/documents/Quote/" + quoteId + ".xml"
def targetURI = "file://$B2BOX_DATA/resources/documents/PurchaseOrder/" + purchaseOrderId + ".xml"
...
def ipk = transaction.buildPK('TransactionInfo', purchaseOrderId)
